...
-- Autor(es) ..............: Antonio Chaves, Arthur Popov, Artur Nunes, Artur Reiman, Cibele Goudinho, Daniel Moreira,  
...
VALUES
    (52.00, 73.00, 50, 'ADAPT-E', 100, 'GEL', 'FQ'),
    (52.00, 70.00, 60, 'AFINATUM', 100, 'GEL', 'FQ'),
    (34.00, 57.00, 67, 'APLASIUM', 50, 'COMPRIMIDO', 'LO'),
    (56.00, 73.00, 50, 'CARDINALIS', 100, 'GEL', 'LO'),
    (45.00, 60.00, 40, 'COMPLEXO B', 90, 'LIQUIDO', 'D'),
    (36.99, 46.00, 2,'COBRE', 50, 'COMPRIMIDO', 'FITO'),
	(42.98, 57.00, 3,'BILIUM', 50, 'LIQUIDO', 'LO'),
	(48.64, 59.00, 4,'ANTILEC', 50, 'GEL', 'FITO'),
	(49.64, 59.00, 5,'GLICOCEPT', 50, 'GEL', 'D'),
	(45.64, 59.00, 3,'TOTALIS', 120, 'COMPRIMIDO', 'D');
...
VALUES
    (65209680134, 'CPF', 'carlosS@gmail.com', 'A+', 'SOL', 'atleta'),
    (70947845119, 'CPF', 'lauraG@gmail.com', 'A+', 'SOL', 'artista'),
	(11091181128, 'CPF', 'gabrielS@gmail.com', 'AB+', 'DV', 'jornalista'),
    (68297744116, 'CPF', 'lucasR@gmail.com', 'AB-', 'CAS', 'eletricista'),
	(79345569189, 'CPF', 'brunoC@gmail.com', 'O+', 'V', 'carteiro'),
	(08432376191, 'CPF', 'josesv@gmail.com','O+', 'SOL', 'Marceneiro'),
	(22553782136, 'CPF', 'biancaMelo@gmail.com','AB-', 'SOL', 'Advogada'),
	(43855115192, 'CPF', 'tonin@hotmail.com','A+', 'CAS', 'Policial'),
	(72300854112, 'CPF', 'clovis123@hotmail.com','O-', 'SOL', 'Engenheiro civil'),
	(18210287168, 'CPF', 'evelynsouza@hotmail.com','AB+', 'SOL', 'Professora');    
    
INSERT INTO PAGAMENTO
    (valorMonetario, dtPagamento, metodoPagamento)
VALUES 
    (300.00, '2022-09-10', 'CC'),
    (300.00, '2022-09-11', 'CC'),
    (300.00, '2022-09-12', 'CD'),
    (300.00, '2022-09-13', 'CD'),
    (300.00, '2022-09-13', 'TB'),
    (300.00, '2022-09-14', 'CD'),
    (300.00, '2022-09-14', 'CC'),
    (300.00, '2022-09-14', 'CD'),
    (300.00, '2022-09-15', 'CD'),
    (300.00, '2022-09-16', 'TB'),
    (150.00, '2022-01-10', 'CD'),
    (150.00, '2022-01-11', 'CC'),
    (150.00, '2022-01-11', 'CD'),
    (150.00, '2022-01-12', 'CD'),
    (150.00, '2022-01-15', 'TB'),
    (150.00, '2022-02-10', 'CD'),
    (150.00, '2022-02-11', 'CC'),
    (150.00, '2022-02-11', 'CD'),
    (150.00, '2022-02-15', 'CD'),
    (150.00, '2022-02-20', 'TB'),
    (130.00, '2022-02-10', 'CD'),
    (230.00, '2022-02-11', 'CC'),
    (130.00, '2022-02-11', 'CD'),
    (230.00, '2022-02-12', 'CD'),
    (130.00, '2022-02-15', 'TB'),
    (130.00, '2022-03-10', 'CD'),
    (230.00, '2022-03-11', 'CC'),
    (130.00, '2022-03-11', 'CD'),
    (230.00, '2022-03-15', 'CD'),
    (130.00, '2022-03-20', 'TB'),
    (73.00, '2022-02-10', 'CD'),
    (70.00, '2022-02-11', 'CC'),
    (57.00, '2022-02-12', 'CD'),
    (73.00, '2022-02-13', 'CD'),
...
VALUES
    ...
    ('2022-01-12', 4, 44681, 'F de energia', 150.00, 14, 79906130, 'Pantaleão Coelho Xavier', 50),
...
INSERT INTO SESSAO
    (idConsulta, dtSessao, numRegistro, precoUnitarioSessao, idPaciente, statusSessao, feedbackRetorno)
VALUES
    (1, '2022-02-10', 16731, 130.00, 1, 'AG', 'Aumento das dores de cabeça'), 
    (2, '2022-02-11', 23780, 230.00, 2, 'CON', 'Melhora da dor nas costas'),
    (3, '2022-02-11', 15790, 130.00, 3, 'AG', 'Dor nas costas continua'),
    (4, '2022-02-12', 44681, 230.00, 4, 'CON', 'Sensação de enjoo continua'),
    (5, '2022-02-15', 53268, 130.00, 5, 'AG', 'Dor no pé continua'),
	(6, '2022-03-10', 61478, 130.00, 6, 'F', 'Dor no peito continua'),
    (7, '2022-03-11', 76531, 230.00, 7, 'AG', 'Palpitação do coração parou'),
    (8, '2022-03-11', 88321, 130.00, 8, 'AD', 'Dores nas costas pararam'),
    (9, '2022-03-15', 98954, 230.00, 9, 'AG', 'Dor de cabeça continuou'),
    (10,'2022-03-20', 10214, 130.00, 10, 'CON', 'Dor nos olhos continuaram');
...
VALUES
    (1, 'É comum estar cansado?', 'S', 'durante o dia apresenta maior cansaço'), 
    (2, 'É comum estar nervoso?', 'N', 'está sempre calmo'),
    (3, 'Acorda indisposto?', 'S', 'principalmente após dormir pouco'),
    (4, 'Possui dificuldade digestiva', 'N', 'consome pouca agua'),
    (5, 'Tem problemas de pele?', 'S', 'aumenta ao contato com o sol'),
    (6, 'É comum estar ansioso?', 'S', 'após eventos que surpreendem o paciente'), 
    (7, 'É comum estar cansado?', 'S', 'mesmo sem fazer esforço'),
    (8, 'Acorda indisposto?', 'N', 'apresenta bom sono'),
    (9, 'Possui dificuldade digestiva', 'N', 'consome alimento com muita fibra'),
    (10, 'Tem problemas de pele?', 'S', 'não deve entrar em contato com sol');    
    
INSERT INTO RESULTADOTESTE
    (predisposicao, verificarProxSessao, idTesteEPI)
VALUES
    ('Predisposiçao genética à arsênico', 'S', 1), 
    ('Predisposiçao genética à chumbo', 'S', 2),
    ('Predisposiçao genética à mercúrio', 'S', 3),
    ('Predisposiçao genética à enxofre', 'N', 4),
    ('Predisposiçao genética à lectina', 'N', 5),
    ('Predisposiçao genética à manganês', 'S', 6), 
    ('Predisposiçao genética à níquel', 'S', 7),
    ('Predisposiçao genética à cobre', 'S', 8),
    ('Predisposiçao genética à ródio', 'N', 9),
    ('Predisposiçao genética à paládio', 'N', 10);
...
INSERT INTO compoe
    (matricula, idTurma, certificadoEmitido)
VALUES 
    (1, 1, 1),
    (2, 2, 0),
    (3, 3, 1),
